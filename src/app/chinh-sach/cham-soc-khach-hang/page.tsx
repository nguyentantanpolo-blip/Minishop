    ...
    <div className="policy-page-container">
      <div className="policy-hero">
        <div className="container">
          <h1 className="policy-title">Chăm Sóc Khách Hàng</h1>
          <p className="policy-subtitle">Hỗ trợ tận tâm, giải đáp mọi thắc mắc 24/7</p>
        </div>
      </div>
      ...
      <div className="container">
        <div className="policy-content">
            ...
            <div className="support-topics">
              <div className="support-topic-item">
                ...
                <ul>
                  ...
                  <li>Thay đổi thông tin đơn hàng</li>
                </ul>
              </div>
              <div className="support-topic-item">
                ...
                <ul>
                  ...
                  <li>Lịch giao hàng dự kiến</li>
                  <li>Xử lý giao hàng không thành công</li>
                  <li>Phí vận chuyển và thời gian</li>
                </ul>
              </div>
              <div className="support-topic-item">
                <h3>💳 Thanh Toán</h3>
              ...
              <div className="support-topic-item">
                ...
                <ul>
                  ...
                  <li>Xử lý sản phẩm lỗi</li>
                  <li>Bảo hành và sửa chữa</li>
                  <li>Thời gian xử lý đổi trả</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <section className="policy-section">
            <h2>3. Quy Trình Giải Quyết Khiếu Nại</h2>
            <div className="process-steps">
              <div className="process-step">
                <div className="step-number">1</div>
                <h3>Tiếp Nhận</h3>
                <p>Khách hàng gửi khiếu nại qua hotline, Zalo hoặc email</p>
              </div>
              <div className="process-step">
                <div className="step-number">2</div>
                <h3>Xác Nhận</h3>
                <p>TANPOLO xác nhận tiếp nhận trong vòng 2 giờ làm việc</p>
              </div>
              <div className="process-step">
                <div className="step-number">3</div>
                <h3>Xử Lý</h3>
                <p>Kiểm tra, xác minh và đề xuất phương án giải quyết</p>
              </div>
              <div className="process-step">
                <div className="step-number">4</div>
                <h3>Hoàn Tất</h3>
                <p>Thực hiện giải pháp và theo dõi đến khi khách hàng hài lòng</p>
              </div>
            </div>
