    ...
    <main className="container" style={{ paddingBottom: '60px' }}>
      ...
      <div className={`modal-overlay ${isCatModalOpen ? 'open' : ''}`}>
        <div className="modal-admin-card" style={{ maxWidth: '520px', width: '100%' }}>
          ...
          <form onSubmit={handleSaveCategoryForm} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div className="form-group">
              <label className="form-label">Mã định danh Slug ID (*)</label>
              <input
                type="text"
                className="form-input"
                required
            ...
            <div className="form-group">
              <label className="form-label">🖼️ Ảnh đại diện danh mục (* Chọn từ máy)</label>
              <div className="image-upload-wrapper">
                {modalCatImage ? (
                  <div className="image-preview-box">
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '10px', marginTop: '12px' }}>
              ...
              <button type="submit" className="btn-admin-add">
                💾 {editingCategory ? 'Cập nhật danh mục' : 'Lưu danh mục mới'}
              </button>
            </div>
          </form>
        </div>
